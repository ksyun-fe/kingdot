...
describe("skeleton", () => {
  ...
  it("create Skeleton of default", () => {
    ...
    expect(vm.$el.querySelector(".kd-skeleton-box")).to.be.have;
  });
  ...
  it("create Skeleton of default active", () => {
    ...
    expect(vm.$el.querySelector(".kd-skeleton-box-active")).to.be.have;
  });
  //验证rows
  it("create Skeleton of default active", () => {
    vm = createCons(Skeleton, {
    ...
    expect(vm.$el.querySelector(".kd-skeleton-item-last")).to.be.null;
  });
  ...
  it("different types Skeleton of round", () => {
    ...
    expect(vm.$el.querySelector(".kd-skeleton-item-round")).to.be.have;
  });
  ...
  it("different types Skeleton of img", () => {
    ...
    expect(vm.$el.querySelector(".kd-skeleton-item-img")).to.be.have;
  });
  ...
  it("change skeletonitem of width&height", () => {
    ...
    let el = vm.$el.querySelector(".kd-skeleton-item-img");
