...
// eslint-disable-next-line max-lines-per-function
    ...
    Sortable.prototype = /** @lends Sortable.prototype */ {
        ...
        _onTapStart: function (/** Event|TouchEvent */evt) {
            ...
            var originalTarget = evt.target.shadowRoot && evt.path[0] || target;
        ...
        _triggerDragStart: function (/** Event */evt, /** Touch */touch, localTarget) {
            touch = touch || (evt.pointerType == 'touch' ? evt : null);

            // if(localTarget.className != 'drag-bar') return;
            // console.log(localTarget.className === 'drag-bar')
            if (touch) {
        ...
        _onDragOver: function (/** Event*/evt) {
            ...
            var isMovingBetweenSortable = false;
            ...
            if (activeSortable && !options.disabled &&
                ...
                if ((el.children.length === 0) || (el.children[0] === ghostEl) ||
                    ...
                    var floating = R_FLOAT.test(lastCSS.cssFloat + lastCSS.display) ||
