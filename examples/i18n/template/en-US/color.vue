<template>
    <div class="article color-wrap">
        <h2>Color</h2>
        <p>As a perceptual design language, color plays an important role in expressing design goals. Therefore, while defining a series of color values, it is more important to standardize their usage methods in actual pages and scenarios.</p>
        <div
